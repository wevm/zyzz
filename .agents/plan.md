...
6. **2.4b — Selectors and Conditions:** pseudos/elements, data/ARIA states, typed marker/ancestor proposals and group/peer/descendant relations, nesting, media/supports/container conditions, and `@starting-style`. Specify helper specificity separately from raw selectors and retain browser behavior.
