...
Reconciled against `main` at [`e1b91ed`](https://github.com/wevm/zyzz/commit/e1b91ed) on September 17, 2026. The web acceptance stack is merged. Its [local evidence and limits](../docs/guides/web-acceptance.md) remain separate from hosted CI, native parity, at-rule rendering, and release measurements.
...
| Native foundation            | Static tables, theme/scheme lookup, portable scalar values, composition, flattening, and absolute-fill helpers are implemented. Universal callable APIs and device acceptance remain open. | [#173](https://github.com/wevm/zyzz/pull/173), [#174](https://github.com/wevm/zyzz/pull/174), [#175](https://github.com/wevm/zyzz/pull/175), [#176](https://github.com/wevm/zyzz/pull/176), [StyleSheet](../src/react-native/StyleSheet.ts) |

## Next work

1. Implement native structured values and typed target branches in 3.8d. The static-table foundation and 3.8a through 3.8c are merged. Imported value-domain and platform audits remain incomplete.
2. Add shared native variants/composition and universal callable compilation in 3.8e and 3.8f.
...
- [ ] Confirm hosted checks on merged `main` at `e1b91ed`. The latest status lookup was blocked by GitHub's API rate limit. Local checks do not establish hosted success.
...
| ----- | ------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 3.8d  | Structured/native-only values and typed target branches.      | Complete static property/value coverage, explicit conversions, native numeric semantics, transforms, colors, fonts, shadows, and platform-specific inputs. |
| 3.8e  | Shared static variants and universal composition.             | Shared inference, defaults, nulls, compounds, ordering, and bounded tables.                                                                                |
