...
7. **2.4c — Stylesheet Contributions:** config layer lists, standalone `Css.layers`, and module-level `Css.global` with project-wide collection and hoisting; keyframes, font faces, and opt-in reset. Implement typed layer placement, source identity, ordering constraints, shared initial CSS, and browser/packaging gates. Variants remain Phase 3.
