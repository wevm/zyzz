...
| [zyzz/babel](babel/README.md) | Compile literal native authoring before Babel language transforms. |
...
| [zyzz/themes/default](themes/default.md)    | Opt-in bundled design tokens and bound recipes. Core `zyzz` imports remain token-free. |
