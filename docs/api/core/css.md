...
Use explicit selectors for application-owned data/ARIA states and ancestor/sibling relationships. Typed marker helpers compile in web `css` definitions. Core `Style.define` and global declarations reject relationship keys.
