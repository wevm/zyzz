...
> [!NOTE]
> Typed relationship helpers compile marker identities and finite data predicates. Layer authoring remains separate. `compile` supports scalar declarations and ordered nested selector/condition blocks.
