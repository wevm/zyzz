...
Theme timings used 3–72 samples per case, and reported relative margins of error ranged from 7.14–68.8%.

The 10-component theme case has smaller gzip delivery with vanilla-extract than Zyzz. Keep this result alongside the larger and literal workloads, since output size depends on the workload.
