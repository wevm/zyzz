...
Use the CLI to precompile source modules and CSS independently of a styling plugin. Authoring still uses the same default-exported config and normal relative imports.
