...
describe('create', () => {
  test('mixed named inputs share isolated scopes and retain the default fallback', () => {
    ...
    expect(output.css).toMatchInlineSnapshot(`
      ...
      .z_base-color-11hsk3q1tuqfr0{color:var(--z0,#06c);}
      .z_base-padding-11rs5sp1tuqfr1{padding:var(--z1,8px);}"
    `)
  ...
  test('single inline themes and reusable extensions retain validated values', () => {
    ...
    expect(
      ...
      ".t_0{--z0:12px;}
      .z_base-padding-11hsk3q1tuqfr0{padding:var(--z0,12px);}"
    `)
    ...
    expect(
      ...
      `".z_base-padding-11hsk3q1tuqfr0{padding:var(--z0,1rem);}"`,
    )
    expect(() =>
      zyzz.css({ padding: 'md' }),
