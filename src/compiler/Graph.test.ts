...
describe('compile', () => {
  ...
  export const label = css({color:theme.tokens.color.brand})
    ...
    expect(output.modules['pkg/card.ts']!.css).toMatchInlineSnapshot(`
      ...
      .z-5ngs574r5xr9-base-padding-ors674n2p4ys{padding:var(--z-t1g1qfxjzbnv3-css-spacing_2e_md,8px);}
      .z-5ngs574r5xr9-base-color-zqak9enmgjio{color:var(--z-t1g1qfxjzbnv3-css-color_2e_brand,#06c);}"
    `)
    expect(output.modules['pkg/card.ts']!.code).toMatchInlineSnapshot(`
      ...
      import { css, theme } from './index.js'; export namespace styles {
        export const card = __zyzzProps.create({className:"z-5ngs574r5xr9-base-padding-ors674n2p4ys z-style-5ngs574r5xr9-89"})

        export const label = __zyzzProps.create({className:"z-5ngs574r5xr9-base-color-zqak9enmgjio z-style-5ngs574r5xr9-133"})
  ...
  export const card = css({color:'brand'})
    ...
    expect(packed.modules['app/card.ts']!.css).toMatchInlineSnapshot(`
      ...
      .z-ujlnau19561g8-base-color-zqak9enmgjio{color:var(--z-t1g1qfxjzbnv3-css-color_2e_brand,#06c);}"
    `)
  })
  ...
  export const card = styled({color:palette.tokens.color.brand})
    ...
    expect(output.modules['app/card.ts']!.css).toMatchInlineSnapshot(`
      ...
      .z-ujlnau19561g8-base-color-oaa02x1aztcf1{color:var(--z-tujlnau19561g8-styled-color_2e_brand,#06c);}"
    `)
  })
...
export const scope = mint.className;`,
    ...
    expect(output.modules['pkg/config.ts']!.css).toMatchInlineSnapshot(`
      ...
      .z-style-1g1qfxjzbnv3-291-color-0-2kt3f2jipgq8{color:var(--z-t1g1qfxjzbnv3-zyzz-color_2e_brand,#06c);}
      .z-style-1g1qfxjzbnv3-341-color-0-tmf32z1of5wif{color:var(--z-t1g1qfxjzbnv3-other-color_2e_brand,#06c);}"
    `)
    expect(
  ...
  test('numeric configuration keys retain tokens and reject string-equivalent duplicates', () => {
    ...
    expect(output.modules['pkg/config.ts']!.css).toMatchInlineSnapshot(`
      ...
      .z-1g1qfxjzbnv3-base-color-1m76ugeenbunm{color:var(--z-t1g1qfxjzbnv3-zyzz-color_2e_brand_2e_500,#06c);}
      .z-1g1qfxjzbnv3-base-padding-qohvyh18qlepr{padding:var(--z-t1g1qfxjzbnv3-zyzz-spacing_2e_2,8px);}"
    `)
    expect(() =>
      Graph.compile({
        modules: {
  ...
  test('dotted catalog keys retain member boundaries in source and packed libraries', () => {
    ...
    expect(Graph.compile(options).modules['app/card.js']!.css)
      .toMatchInlineSnapshot(`
        ...
        .z-115845g13hgi1q-base-color-7swwt9il7frp{color:var(--z-t1fzmg4ts3ctu1-zyzz-color_2e_brand,#06c);}"
      `)
    expect(() =>
      Graph.compile({
        ...options,
  ...
  test('configuration defaults, aliases, edits, and packed metadata retain the same contract', () => {
    ...
    expect(output.modules['pkg/card.ts']!.css).toMatchInlineSnapshot(`
      ...
      .z-5ngs574r5xr9-base-color-majjo590ld41{color:var(--z-t69adjg15dlzyu-zyzz-color_2e_brand,light-dark(#06c,#9cf));}
      .z-5ngs574r5xr9-base-padding-xearee1i8acco{padding:var(--z-t69adjg15dlzyu-zyzz-spacing_2e_md,8px);}"
    `)
    ...
    expect(packed.modules['app/card.ts']!.css).toMatchInlineSnapshot(`
      ...
      .z_theme-69adjg15dlzyu-zyzz-mint{--z-t69adjg15dlzyu-zyzz-color_2e_brand:light-dark(#175,#afa);--z-t69adjg15dlzyu-zyzz-spacing_2e_md:12px;}
      .z_theme-69adjg15dlzyu-zyzz-base{--z-t69adjg15dlzyu-zyzz-color_2e_brand:light-dark(#06c,#9cf);--z-t69adjg15dlzyu-zyzz-spacing_2e_md:8px;}
      .z-ujlnau19561g8-base-color-majjo590ld41{color:var(--z-t69adjg15dlzyu-zyzz-color_2e_brand,light-dark(#06c,#9cf));}
      .z-ujlnau19561g8-base-padding-xearee1i8acco{padding:var(--z-t69adjg15dlzyu-zyzz-spacing_2e_md,8px);}"
    `)
    expect(packed.modules['app/card.ts']!.code).toMatchInlineSnapshot(
      `"import { design as zyzz } from '@acme/theme'; export const props = ({className:"z-ujlnau19561g8-base-color-majjo590ld41 z-ujlnau19561g8-base-padding-xearee1i8acco"}); export const scope = "z_theme-69adjg15dlzyu-zyzz-mint";"`,
    )
  })
  ...
  test('serialized library contracts link aliases, extensions, and consumer scopes', () => {
    ...
    expect(updated.modules['app/card.ts']!.classes).toMatchInlineSnapshot(`
      {
        "style-ujlnau19561g8-164": "z-ujlnau19561g8-base-color-glyi11tqu4wn z-ujlnau19561g8-base-padding-17fqep7qoel5v",
      }
    `)
  ...
  test('imported aliases retain shadowed bindings', () => {
    ...
    expect(output.modules['pkg/card.ts']!.code).toMatchInlineSnapshot(
      `"import { css } from './theme.js'; export function run(css: (value: string) => string) { return css('ordinary') } export const props = ({className:"z-5ngs574r5xr9-base-color-ue7dvl1l8hzz9"});"`,
    )
  })
  ...
  test('imports, aliases, extensions and re-exports share token identities and source maps', async () => {
    ...
    `)
    expect(output.modules['pkg/card.ts']!.code).toMatchInlineSnapshot(
      `"import { theme, style, mint } from './index.js'; export const props = ({className:"z-5ngs574r5xr9-base-color-ue7dvl1l8hzz9 z-5ngs574r5xr9-base-padding-1mq8d2717fuj81"}); export const scope = "z_theme-18i5hb1ihk25d-mint";"`,
    )
    expect(output.modules['pkg/card.ts']!.css).toMatchInlineSnapshot(`
      ...
      .z-5ngs574r5xr9-base-color-ue7dvl1l8hzz9{color:var(--z-t1p8at5ioin1tk-theme-color_2e_brand,#06c);}
      .z-5ngs574r5xr9-base-padding-1mq8d2717fuj81{padding:var(--z-t1p8at5ioin1tk-theme-spacing_2e_md,8px);}"
    `)
    expect(
    ...
    try {
      ...
      expect(executed.stdout).toMatchInlineSnapshot(`
        "{"props":{"className":"z-5ngs574r5xr9-base-color-ue7dvl1l8hzz9 z-5ngs574r5xr9-base-padding-1mq8d2717fuj81"},"scope":"z_theme-18i5hb1ihk25d-mint"}
        "
      `)
  ...
  test('token edits preserve identities and removing the last use removes declarations', () => {
    ...
    expect(after.modules['pkg/card.ts']!.classes).toMatchInlineSnapshot(`
      {
        "style-5ngs574r5xr9-70": "z-5ngs574r5xr9-base-color-1f5xla41kb9f52 z-5ngs574r5xr9-base-padding-1mq8d2717fuj81",
      }
    `)
    ...
    expect(before.modules['pkg/card.ts']!.classes).toMatchInlineSnapshot(`
      {
        "style-5ngs574r5xr9-70": "z-5ngs574r5xr9-base-color-ue7dvl1l8hzz9 z-5ngs574r5xr9-base-padding-1mq8d2717fuj81",
      }
    `)
...
describe('create', () => {
  ...
  test('a consumer edit retains unrelated transforms and snapshots caller inputs', () => {
    ...
    expect(after.modules['pkg/card0.ts']!.css).toMatchInlineSnapshot(`
      ...
      .z-1k1dzu31vy9i39-base-color-ue7dvl1l8hzz9{color:var(--z-t1p8at5ioin1tk-theme-color_2e_brand,#06c);}
      .z-1k1dzu31vy9i39-base-padding-14q167e60x2jc{padding:20px;}"
    `)
    expect(before.modules['pkg/card0.ts']!.css).toMatchInlineSnapshot(`
      ".z_theme-1p8at5ioin1tk-theme{--z-t1p8at5ioin1tk-theme-color_2e_brand:#06c;}
      .z_theme-18i5hb1ihk25d-mint{--z-t1p8at5ioin1tk-theme-color_2e_brand:#175;}
      .z-1k1dzu31vy9i39-base-color-ue7dvl1l8hzz9{color:var(--z-t1p8at5ioin1tk-theme-color_2e_brand,#06c);}
      .z-1k1dzu31vy9i39-base-padding-15505xuf8zjbe{padding:0px;}"
    `)
  })
  ...
  test('theme edits propagate through re-exports and preserve defining source maps', () => {
    ...
    expect(after.modules['pkg/card.ts']!.css).toMatchInlineSnapshot(`
      ...
      .z_theme-18i5hb1ihk25d-mint{--z-t1p8at5ioin1tk-theme-color_2e_brand:#175;--z-t1p8at5ioin1tk-theme-spacing_2e_md:8px;}
      .z-5ngs574r5xr9-base-color-1f5xla41kb9f52{color:var(--z-t1p8at5ioin1tk-theme-color_2e_brand,#f00);}
      .z-5ngs574r5xr9-base-padding-1mq8d2717fuj81{padding:var(--z-t1p8at5ioin1tk-theme-spacing_2e_md,8px);}"
    `)
...
describe('create', () => {
  test('host resolution controls aliases and invalidates changed targets', () => {
    ...
    expect(after.modules['pkg/card.ts']!.css).toMatchInlineSnapshot(`
      ...
      .z-5ngs574r5xr9-base-color-1k2obbwnzodpa{color:var(--z-tc1mlirqoc0mf-theme-color_2e_brand,#fff);}"
    `)
