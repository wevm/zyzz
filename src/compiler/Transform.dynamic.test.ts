...
describe('compile', () => {
  ...
  test('unwraps non-null callback bodies before binding theme variables', () => {
    expect(
      ...
      .z-text-10qvms411r52zg{color:var(--z-t10qvms41gznlvu-t-color_2e_ink,red);}
      .z-opacity-10qvms411r52zg{opacity:var(--z-d10qvms41gznlvu-71-61-6c-70-68-61);}"
    `)
  })
  ...
  test('retains static fallbacks in asserted theme callbacks', () => {
    expect(
      ...
      .z-opacity-181sefq3c880w{opacity:var(--z-d181sefq1osze6y-71-61-6c-70-68-61);}
      .z-text-181sefq3c880w{color:blue;color:var(--z-t181sefq1osze6y-t-color_2e_ink,red);}"
    `)
  })
  test('compiles callbacks to fixed rules and preserves callable values', async () => {
    ...
    expect(output.css).toMatchInlineSnapshot(
      `
      ".z-block-1h5daylw32dcp{display:block;}
      .z-w-1h5daylw32dcp{width:var(--z-d1h5dayl7tfv4v-47-61-6d-6f-75-6e-74);}
      .z-ml-1h5daylw32dcp{margin-left:calc(var(--z-d1h5dayl7tfv4v-47-67-61-70) + 2px);}
      .z-opacity-1h5daylw32dcp{opacity:var(--z-d1h5dayl7tfv4v-47-61-6c-70-68-61);}"
    `,
    )
    ...
    expect(module.first).toMatchInlineSnapshot(`
      {
        "className": "z-block-1h5daylw32dcp z-w-1h5daylw32dcp z-ml-1h5daylw32dcp z-opacity-1h5daylw32dcp z-style-1h5dayl7tfv4v-47",
        "style": {
    ...
    expect(
      ...
      {
        "className": "z-block-1h5daylw32dcp z-w-1h5daylw32dcp z-ml-1h5daylw32dcp z-opacity-1h5daylw32dcp z-style-1h5dayl7tfv4v-47 external",
        "style": {
  ...
  test('mixes bound theme references with static and dynamic declarations', () => {
    expect(
      ...
      .z-text-1aby40l1el80w5{color:var(--z-t1aby40l12ykqib-theme-color_2e_brand,red);}
      .z-opacity-1aby40l1el80w5{opacity:var(--z-d1aby40l12ykqib-100-61-6c-70-68-61);}"
    `)
  })
  ...
  test('encodes identifier characters in private CSS names', () => {
    expect(
      ...
      `".z-opacity-ijyhsi5yh92s{opacity:var(--z-dijyhsi11fth46-28-24-61-6c-70-68-61);}"`,
    )
  })
