...
export namespace styles {
  export const list = css({listStyleType:dots,fontPalette:palette,positionTryFallbacks:below})
    ...
    expect(output.css).toMatchInlineSnapshot(`
      ...
      .z-list-style-type-141558i1eh5kig{list-style-type:z-counterstyle141558i1cjhj8q-64-6f-74-73;}
      .z-font-palette-141558i1eh5kig{font-palette:--z-fontpalettevalues141558i1cjhj8q-70-61-6c-65-74-74-65;}
      .z-position-try-fallbacks-141558i1eh5kig{position-try-fallbacks:--z-positiontry141558i1cjhj8q-62-65-6c-6f-77;}"
    `)
    expect(
      output.code
        .split('\n')
      ...
      export namespace styles {
        export const list = __zyzzProps.create({className:"z-list-style-type-141558i1eh5kig z-font-palette-141558i1eh5kig z-position-try-fallbacks-141558i1eh5kig z-style-141558i1cjhj8q-507"})
      }"
    `)
  })
  ...
  export const list = css({listStyleType:alias})
    ...
    expect(output.modules['app.ts']!.css).toMatchInlineSnapshot(
      `".z-list-style-type-1e8a67zly006l{list-style-type:z-counterstyle141558i1cjhj8q-64-6f-74-73;}"`,
    )
    expect(
