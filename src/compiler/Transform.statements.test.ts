...
describe('compile', () => {
  ...
  export const box = css({opacity:twice(+1)})
    ...
    expect(output.css).toMatchInlineSnapshot(`
      ...
      .z-opacity-172pjpvaosj{opacity:--z-cssfunction172pj15vy9qt-74-77-69-63-65(1);}"
    `)
  })
  ...
  export const box = css({[compact]:{color:'red'}})
    ...
    expect(output.modules['app.ts']!.css).toMatchInlineSnapshot(
      `".z-text-11pns2i183eixo-0{@media (--z-custommedia658bb2ype01s-63-6f-6d-70-61-63-74){color:red;}}"`,
    )
  })
  ...
  export const box = css({width:twice('2px')})
    ...
    expect(output.modules['app.ts']!.css).toMatchInlineSnapshot(
      `".z-w-1e8a67zly006l{width:--z-cssfunction1sp21u81389mcs-74-77-69-63-65(2px);}"`,
    )
  })
