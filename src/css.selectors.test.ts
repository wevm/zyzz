...
describe('selectors', () => {
  test('resolves standalone selector maps and spreads in static and dynamic definitions', () => {
    ...
    expect(result.modules['shared.ts']!.css).toMatchInlineSnapshot(`
      ".z-style-1stl7if1lvmpx3-167-atomic-color-0{&:hover{color:red;}}
      .z-style-1stl7if1lvmpx3-167-atomic-color-1{.z-style-1stl7if1lvmpx3-52 > &{color:blue;}}
      .z-style-1stl7if1lvmpx3-211-atomic-color-0{&:hover{color:red;}}
      .z-style-1stl7if1lvmpx3-211-atomic-color-1{.z-style-1stl7if1lvmpx3-52 > &{color:blue;}}
      .z-style-1stl7if1lvmpx3-211-atomic-color-2{&:focus{color:green;}}
      .z-style-1stl7if1lvmpx3-297-atomic-color-0{&:hover{color:red;}}
      .z-style-1stl7if1lvmpx3-297-atomic-color-1{.z-style-1stl7if1lvmpx3-52 > &{color:blue;}}
      .z-style-1stl7if1lvmpx3-297-atomic-opacity-2{opacity:var(--z-d1stl7if1lvmpx3-297-6f-70-61-63-69-74-79);}"
    `)
  })
...
export const child = config.css({selectors:{[\`\${themed} > &, \${configured} + &\`]:{ color: 'red' }}});`,
    ...
    expect(result.modules['empty.ts']!.code).toMatchInlineSnapshot(`
      ...
      export const child = (__zyzzCompositionHtml.bind(__zyzzProps.create({className:"z-style-urrzb11meswl3-259-atomic-color-0 z-style-urrzb11meswl3-259"})) as import('zyzz').css.ReturnType<'html'>);"
    `)
    expect(result.modules['empty.ts']!.css).toMatchInlineSnapshot(
      `".z-style-urrzb11meswl3-259-atomic-color-0{.z-style-urrzb11meswl3-156 > &, .z-style-urrzb11meswl3-195 + &{color:red;}}"`,
    )
  })
  ...
  test('compiles namespace definitions and scoped selectors', () => {
    ...
    expect(result.modules['app.ts']!.css).toMatchInlineSnapshot(`
      ".z-style-1e8a67z1uaws1j-74-atomic-padding-0{padding:16px;}
      .z-style-1e8a67z1uaws1j-151-atomic-color-0{color:black;}
      .z-style-1e8a67z1uaws1j-151-atomic-color-1{.z-style-1e8a67z1uaws1j-74:hover &{color:blue;}}
      .z-style-1e8a67z1uaws1j-151-atomic-opacity-2{.z-style-1e8a67z1uaws1j-74 > &:nth-child(even){opacity:0.5;}}
      .z-style-1e8a67z1uaws1j-151-atomic-fontWeight-3{.z-style-1e8a67z1uaws1j-122 + &{font-weight:700;}}
      .z-style-1e8a67z1uaws1j-334-atomic-margin-0{.z-style-1e8a67z1uaws1j-74 > &{margin:0;}}"
    `)
    expect(result.modules['app.ts']!.code).toMatchInlineSnapshot(`
      ...
      export namespace styles {
        export const card = __zyzzProps.create({className:"z-style-1e8a67z1uaws1j-74-atomic-padding-0 z-style-1e8a67z1uaws1j-74"})
        export const empty = __zyzzProps.create({className:"z-style-1e8a67z1uaws1j-122"})
        export const label = __zyzzProps.create({className:"z-style-1e8a67z1uaws1j-151-atomic-color-0 z-style-1e8a67z1uaws1j-151-atomic-color-1 z-style-1e8a67z1uaws1j-151-atomic-opacity-2 z-style-1e8a67z1uaws1j-151-atomic-fontWeight-3 z-style-1e8a67z1uaws1j-151"})
      }
      export const outside = __zyzzProps.create({className:"z-style-1e8a67z1uaws1j-334-atomic-margin-0 z-style-1e8a67z1uaws1j-334"})"
    `)
  })
  ...
  test('resolves aliases and named re-exports across source and packed modules', () => {
    ...
    expect(result.modules['app.ts']!.css).toMatchInlineSnapshot(
      `".z-style-1e8a67z1uaws1j-113-atomic-color-0{.z-style-ggnaaj17b3mnh-48 > &, .z-style-ggnaaj17b3mnh-103 + &{color:blue;}}"`,
    )
    expect(
...
export {card,other,nested};`,
    ...
    expect(result.modules['scoped.ts']!.code).toMatchInlineSnapshot(`
      ...
      const card=__zyzzProps.create({className:"z-style-1kmi93w1julwr4-37-atomic-color-0 z-style-1kmi93w1julwr4-37"}); const alias=card;
      const other=__zyzzProps.create({className:"z-style-1kmi93w1julwr4-87-atomic-color-0 z-style-1kmi93w1julwr4-87"});
      function nested(){ const card=other; return __zyzzProps.create({className:"z-style-1kmi93w1julwr4-151-atomic-color-0"}) }
      export {card,other,nested};"
    `)
    expect(result.modules['scoped.ts']!.css).toMatchInlineSnapshot(`
      ".z-style-1kmi93w1julwr4-37-atomic-color-0{color:red;}
      .z-style-1kmi93w1julwr4-87-atomic-color-0{color:red;}
      .z-style-1kmi93w1julwr4-151-atomic-color-0{.z-style-1kmi93w1julwr4-37:hover &{color:blue;}}"
    `)
  })
...
const card=css({}); export const label=css((values:{opacity:number})=>({selectors:{[\`\${card}:hover &\`]:{opacity:values.opacity}}}));`,
    ...
    expect(result.modules['dynamic.ts']!.code).toMatchInlineSnapshot(`
      ...
      const card=__zyzzProps.create({className:"z-style-1h5dayl7tfv4v-37"}); export const label=(((input:Parameters<import('zyzz').css.Dynamic<{opacity:number}>>[0])=>{const v0=input["opacity"] as string | number;const external=input.className;const style=input.style;return {className:external?"z-style-1h5dayl7tfv4v-65-atomic-opacity-0 z-style-1h5dayl7tfv4v-65"+" "+external:"z-style-1h5dayl7tfv4v-65-atomic-opacity-0 z-style-1h5dayl7tfv4v-65",style:{...input.variables,...style,"--z-d1h5dayl7tfv4v-65-6f-70-61-63-69-74-79":v0===''?' ':v0}}}) as import('zyzz').css.Dynamic<{opacity:number}>);"
    `)
    expect(() =>
      Source.extract({
...
namespace styles {
  ...
  export const child=css(shared);
    ...
    expect(output.modules['static.ts']!.css).toMatchInlineSnapshot(
      `".z-style-15wl7di1emu9we-211-atomic-color-0{.z-style-15wl7di1emu9we-117:hover &{color:red;}}"`,
    )
  })
