...
test('packed public entrypoint runs in an isolated consumer', async () => {
  ...
  try {
    ...
    const manifest: { dependencies?: unknown } = JSON.parse(
      await Fs.readFile(Path.join(target, 'package.json'), 'utf8'),
    )
    expect({
      consumer: JSON.parse(result.stdout),
      dependencies: manifest.dependencies,
      directory,
      files: (await Fs.readdir(target, { recursive: true })).sort(),
    }).toMatchInlineSnapshot(
      {
        directory: expect.stringMatching(/[/\\]typestyle-consumer-[^/\\]+$/),
      },
      `
      {
        "consumer": {
        ...
        "directory": StringMatching /\\[/\\\\\\\\\\]typestyle-consumer-\\[\\^/\\\\\\\\\\]\\+\\$/,
        "files": [
          "README.md",
          "dist",
          "dist/Style.d.ts",
          ...
          "dist/index.js.map",
          "dist/internal",
          "dist/internal/Literal.d.ts",
          "dist/internal/Literal.d.ts.map",
          "dist/internal/Literal.js",
          "dist/internal/Literal.js.map",
          "package.json",
          "src",
          "src/Style.ts",
          "src/index.ts",
          "src/internal",
          "src/internal/Literal.ts",
        ],
      }
    `,
    )
