...
Chromium 153.0.8010.0 native/source/packed CSSOM probes close the 57 unreviewed compatibility records. The matrix now records 20 native, 60 partial, and four unsupported entries. CSSOM retention establishes only partial compatibility; it does not promote any renderer status.
