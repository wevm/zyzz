...
export const box=css({borderStyle:'solid',borderWidth:'1px 2px 3px 4px',inset:'1px 2px 3px 4px',margin:'4px 8px 12px 16px',marginInline:'20px 30px',padding:['1px 2px','4px 8px 12px 16px!'],paddingLeft:'99px',scrollMargin:'1px 2px 3px 4px',scrollPaddingInline:'10% auto'})();`
