...
export const values = {
  ...
  glyphOrientationVertical: ['auto', '0deg', '90deg', 0, 90],
  ...
  quotes: ['"\u00ab" "\u00bb" "\u2039" "\u203a"', 'auto'],
  rowRule: ['1px solid red', 'repeat(2, 1px dashed blue)'],
  rowRuleColor: ['red, blue', 'repeat(2, red, blue)'],
  rowRuleStyle: ['solid, dashed', 'repeat(2, solid, dashed)'],
  rowRuleWidth: ['1px, thick', 'repeat(2, 1px, 2px)'],
  ruleInset: ['10px 20% / overlap-join', '-1px'],
