...
export const modules = {
  ...
  'pkg/card.ts': `import { design } from './index.js'; const zyzz = design; const { css } = zyzz; export const props = css({color:zyzz.themes.base.tokens.color.brand,padding:'md'})(); export const scope = zyzz.themes.mint.className;`,
}
