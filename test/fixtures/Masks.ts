...
export const mask=css({backgroundPositionX:'10px',backgroundPosition:'right',imageRendering:'pixelated',maskClip:'padding-box',maskComposite:'add',maskMode:'alpha',maskOrigin:'padding-box',maskPosition:'left',maskRepeat:'no-repeat',maskSize:['auto','50%!'],maskType:'alpha',objectPosition:'bottom',perspective:'300px',perspectiveOrigin:'center',shapeMargin:'5%',transformBox:'border-box',transformOrigin:'right'})();
export const axis=css({backgroundPositionX:'20px'})();`
