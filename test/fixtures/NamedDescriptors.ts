...
export const definitions = {
  counter: `export const name=counterStyle({ '@layer names': { '@media print': {system:'additive',additiveSymbols:'10 "X", 1 "I", 0 "O"',fallback:'decimal',negative:'"(" ")"',pad:'2 "0"',prefix:'"["',range:'0 99',speakAs:'numbers',suffix:'"]"',symbols:'"I"'} } });global({body:{listStyleType:name}});`,
  font: `fontFace({ '@layer names': { '@media print': {fontFamily:'Body',src:'local("Body"),url(/body.woff2) format("woff2")',fontDisplay:'swap',fontFeatureSettings:'"kern" 1',fontVariationSettings:'"wght" 450',fontStretch:'75% 125%',fontStyle:'oblique 0deg 20deg',fontWeight:'100 900',unicodeRange:'U+0-7F,U+4??',ascentOverride:'90%',descentOverride:'20%',lineGapOverride:'5%',sizeAdjust:'110%'} } });`,
  palette: `export const name=fontPaletteValues({ '@layer names': { '@media print': {fontFamily:'Body, "Other Body"',basePalette:'dark',overrideColors:'0 red, 1 color(display-p3 0 1 0), 1 #00f'} } });global({body:{fontPalette:name}});`,
  position: `export const name=positionTry({ '@layer names': { '@media print': {positionArea:'bottom',positionAnchor:'--target',margin:'4px',marginBlock:'1px 2px',marginInline:'3px 4px',marginBlockStart:'1px',marginBlockEnd:'2px',marginInlineStart:'3px',marginInlineEnd:'4px',marginTop:'1px',marginBottom:'2px',marginLeft:'3px',marginRight:'4px',width:'100px',height:'20px',minWidth:'1px',maxWidth:'200px',minHeight:'1px',maxHeight:'50px',blockSize:'20px',inlineSize:'100px',minBlockSize:'1px',maxBlockSize:'50px',minInlineSize:'1px',maxInlineSize:'200px',inset:'auto',insetBlock:'auto',insetInline:'auto',insetBlockStart:'auto',insetBlockEnd:'auto',insetInlineStart:'auto',insetInlineEnd:'auto',top:'auto',right:'auto',bottom:'auto',left:'auto',alignSelf:'center',justifySelf:'center',placeSelf:'center'} } });global({body:{positionTryFallbacks:name}});`,
} as const
