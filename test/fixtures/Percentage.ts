...
export const high = css({opacity:['50%', '150%!'],fillOpacity:2,strokeOpacity:'125%'})();
export const low = css({opacity:-1,floodOpacity:'-25%',stopOpacity:2})();
export const text = css({fontStretch:'120%',fontWidth:'125%',textSizeAdjust:'110%',zoom:'125%'})();`
