...
export const borders = css({WebkitBorderBefore:'2px solid red',borderBlockStartColor:'blue',WebkitBorderStart:'3px dashed green'})();
export const text = css({WebkitTextFillColor:'rgb(10 20 30)',WebkitTextStrokeWidth:'2px',WebkitTextStrokeColor:'red',WebkitUserSelect:'none',userSelect:'text'})();
export const legacy = css({MozAppearance:'button',MsAccelerator:'true',MsScrollbar3dlightColor:'red',MsContentZoomLimitMax:'200%',WebkitMaskComposite:'source-over, xor',WebkitMaskPositionX:'left, 20%'})();`
